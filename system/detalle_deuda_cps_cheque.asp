...
<table width="680" height="429" border="0">
  ...
  <tr>
	...
	abrirscg()
	ssql=""
	ssql="SELECT FECHAVENC,NRODOC,VALORCUOTA,SALDO,GASTOSCOBRANZAS,INTERESES,CODCOBRADOR,NROCUOTA,GLOSA FROM CUOTA WHERE RUTDEUDOR='"&rut&"' AND CODCLIENTE='"&cliente&"'"
