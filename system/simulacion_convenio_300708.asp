...
<%
	...
	''strMandante="INSTITUTO AIEP"


	''strSql="exec s_Trae_Detalle_Deuda '" & strRutDeudor &"'," & intCodCliente
	''strSql="SELECT * FROM CUOTA WHERE RUTDEUDOR = '" & strRutDeudor & "' AND CODCLIENTE = '" & intCodCliente & "'"
	...
	strSql = "SELECT TOP 1 INDEM_COMPENSATORIA, HONORARIOS, INTERESES, GASTOS_JUDICIALES FROM DEMANDA WHERE CODCLIENTE = '" & intCodCliente & "' AND RUTDEUDOR = '" & strRutDeudor & "'"
	...
	intTotalCostas = VALNULO(intTotIndemComp + intTotGastos + intTotHonorarios,"N")
			...
			<TD>
				...
				<TABLE ALIGN="CENTER" WIDTH="150" BORDER="0">
				  ...
				  <TR HEIGHT=30>
					  ...
					  <TD><input name="capital" type="text" size="10"></TD>
				  </TR>
				  <TR HEIGHT=30>
						<TD ALIGN="RIGHT" class="Estilo23">Gastos Judiciales:</TD>
						<TD><input name="gastos" type="text" size="10"></TD>
				  </TR>

				 <TR HEIGHT=30 BGCOLOR="#CCCCFF">
					  <TD ALIGN="RIGHT" class="Estilo23">IndemComp:</TD>
						<TD><input name="indemComp" type="text" size="10"></TD>
				  </TR>
				  ...
				  <TR HEIGHT=30 BGCOLOR="#CCCCFF">
					...
					<TD><input name="honorarios" type="text" size="10"></TD>
					</TR>
					<TR HEIGHT=30>
						<TD>&nbsp</TD>
						<TD>&nbsp</TD>
