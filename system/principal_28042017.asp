									...
									<tr>
									 ...
									 <tr>
										<td><acronym title="RUT EN FORMATO SIN PUNTOS EJ: 11111111-1">
										  ...
										  <input name="li_"  class="boton_azul" type="button" onClick="window.navigate('principal.asp?Limpiar=1');" value="Limpiar">
...
-->
																<input name="BT_BIBLIOTECA" class="boton_azul" type="button" id="BT_BIBLIOTECA" onClick="javascript:ventanaBiblioteca('biblioteca_deudores.asp?strRut=<%=rut%>');" value="--Documentos--"><td>
																<!--
