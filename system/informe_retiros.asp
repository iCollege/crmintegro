	...
	<table width="100%" border="0">
		...
		<tr>
			...
			<select name="CB_CLIENTE" onChange="refrescar();">
				<%
				abrirscg()
				ssql="SELECT CODCLIENTE,RAZON_SOCIAL FROM CLIENTE WHERE CODCLIENTE = '" & intCliente & "' ORDER BY RAZON_SOCIAL"
  ...
  <tr bgcolor="#<%=session("COLTABBG")%>">
	...
	If Not rsFechas.eof Then
		...
		For I = 1 To intDias
			...
			strSql = strSql & " AND CONVERT(VARCHAR(10),FECHA_ESTADO,103) = '" & intFecha & "' AND ESTADO_DEUDA IN "
