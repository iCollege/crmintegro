...
<%
	...
	session("session_idusuario")=Trim(Replace(VstrQS(2),"usuario=",""))
									...
									<tr>
									 ...
									 <tr>
										<td><acronym title="RUT EN FORMATO SIN PUNTOS EJ: 11111111-1">
										  ...
										  <input name="li_"  class="boton_azul" type="button" onClick="window.navigate('mod_discador.asp?Limpiar=1');" value="Limpiar">
...
function envia_dir(){
datos.action='mod_discador.asp?dir=si';
datos.submit();
}

function envia_fon(){
datos.action='mod_discador.asp?fon=si';
datos.submit();
}

function envia_mail(){
datos.action='mod_discador.asp?mail=si';
datos.submit();
}
