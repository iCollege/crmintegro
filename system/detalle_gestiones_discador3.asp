...
rESPONSE.eND
	...
	if rut="" then
		...
		if not rut="" then
			...
			If (Trim(categoria) = "2" and Trim(subcategoria) = "1" and Trim(gestion) = "1")
				strEstado = "10"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "1"  and Trim(gestion) = "2") Then
				strEstado = "10"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "1") Then
				strEstado = "20"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "2") Then
				strEstado = "20"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "3") Then
				strEstado = "20"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "4") Then
				strEstado = "20"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "5") Then
				strEstado = "20"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "6") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "7") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "8") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "9") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "3"  and Trim(gestion) = "1") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "3"  and Trim(gestion) = "3") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "4"  and Trim(gestion) = "1") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "4"  and Trim(gestion) = "2") Then
				strEstado = "20"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "4"  and Trim(gestion) = "3") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "4"  and Trim(gestion) = "4") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "5"  and Trim(gestion) = "1") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "5"  and Trim(gestion) = "2") Then
				strEstado = "20"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "5"  and Trim(gestion) = "3") Then
				strEstado = "10"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "5"  and Trim(gestion) = "4") Then
				strEstado = "20"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "1") Then
				strEstado = "10"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "2") Then
				strEstado = "10"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "3") Then
				strEstado = "10"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "4") Then
				strEstado = "10"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "5") Then
				strEstado = "10"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "7"  and Trim(gestion) = "1") Then
				strEstado = "30"
			Else If (Trim(categoria) = "2" and Trim(subcategoria) = "7"  and Trim(gestion) = "2") Then
				strEstado = "30"
			End If
			...
			If strEstado <> "" Then
				strSql = "UPDATE TBD_CAMPANA_DISCADOR SET ESTADO = " & strEstado & ", AGENTE = " &  session("session_idusuario_call")
				strSql = strSql & " WHERE RUT = '" & rut & "' AND COD_CLIENTE = '" & cliente & "'"
				'Response.write "strSql=" & strSql
				Conn.execute(strSql)
			End If
