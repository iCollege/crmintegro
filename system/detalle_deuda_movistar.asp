...
<table width="760" height="420" border="0">
  ...
  <tr>
    ...
    abrirscg()
	ssql=""
	ssql="SELECT NRODOC,VALORCUOTA,SALDO,GASTOSCOBRANZAS,CODCOBRADOR,INTERESES,CODDEUDOR,NROCUOTA,CODREMESA,NSERVICIO,FECHAVENC,CODREMESA,FECHAEMISION FROM CUOTA WHERE RUTDEUDOR='"&rut&"' AND CODCLIENTE='"&cliente&"' AND ETAPACOBRANZA <>'ST6'"
	...
	<table width="100%" border="0" bordercolor="#FFFFFF">
        <tr bordercolor="#999999" bgcolor="#<%=session("COLTABBG")%>" class="Estilo13">
          ...
          <td width="5%"><div align="left">N&ordm; SERVICIO </div></td>
          ...
          <td width="10%"><div align="left">MONTO</div></td>
          <td width="10%"><div align="left">SALDO</div></td>
          <td width="10%"><div align="left">INTERES</div></td>
        ...
        <tr bordercolor="#999999" >
          ...
          <td><div align="right">
              <%
		  sql_rem="SELECT FECHA_LLEGADA FROM REMESA WHERE COD_CLI='"&cliente&"' and CODREMESA='"&rsDET("CODREMESA")&"'"
