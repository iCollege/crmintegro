...
<%
	...
	If Not rsCierre.Eof Then
		%>
		<SCRIPT>
			alert('Caja Cerrada, No puede ingresar pagos para el día de hoy')
		</SCRIPT>
		<%
...
<table width="840" border="1" bordercolor="#999999" cellpadding="2" cellspacing="5">
	<tr>
		<td height="20"  bordercolor="#999999"  bgcolor="#<%=session("COLTABBG")%>" class="Estilo27" align="center"><strong>Módulo de Ingreso de Pagos Empresa</strong></td>
	</tr>
	<tr>
