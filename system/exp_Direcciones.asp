...
If strArchivo <> "" Then
	...
	strTextoTercero = "ID_DIRECCION;RUTDEUDOR;CORRELATIVO;FECHAINGRESO;CALLE;NUMERO;RESTO;COMUNA;CIUDAD;USRINGRESO;FECHAREVISION;ESTADO;FUENTE;USRREVISION"
	...
	strSql="SELECT IDDIRECCION,RUTDEUDOR,CORRELATIVO,FECHAINGRESO,CALLE,NUMERO,RESTO,COMUNA,CIUDAD,USRINGRESO,FECHAREVISION,ESTADO,FUENTE,USRREVISION "
	strSql = strSql & " INTO TMP_EXPORT_DIRECCIONES_" & session("session_idusuario")
	strSql = strSql & " FROM DEUDOR_DIRECCION"
	...
	Do While Not rsTemp.Eof
		...
		strTextoTercero = rsTemp("IDDIRECCION") & ";" & rsTemp("RUTDEUDOR") & ";" & rsTemp("CORRELATIVO") & ";" & rsTemp("FECHAINGRESO") & ";" & rsTemp("CALLE")  & ";" & rsTemp("NUMERO")  & ";" & rsTemp("RESTO")  & ";" & rsTemp("COMUNA")  & ";" & rsTemp("CIUDAD")  & ";" & rsTemp("USRINGRESO") & ";" & rsTemp("FECHAREVISION") & ";"
