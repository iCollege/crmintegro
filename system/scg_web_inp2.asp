...
%>
	...
	<tr>
                      ...
                      <td height="331" valign="top" background="../images/fondo_coventa.jpg"><table width="100%" border="0">
                          ...
                          <tr>
                            <td><acronym title="RUT EN FORMATO SIN PUNTOS EJ: 10111222-3">
                              ...
                              <input name="li_" type="button" onClick="window.navigate('scg_web_inp2.asp');" value="Limpiar">
		...
		ssql2="SELECT TOP 1 NOMBRE,RUT FROM DEUDOR_INP WHERE RUT='"&rut&"' AND NOMBRE IS NOT NULL"
		...
		if existe = "si" or existeinp="si" then
		...
		%>
                          ...
                          <table width="100%" height="0%" border="0" bordercolor="#FFFFFF">
                            <tr bordercolor="#999999" bgcolor="#<%=session("COLTABBG")%>" class="Estilo13">
                              ...
                              <td width="26%">GESTIONES</td>
                              <td width="10%">DOCS</td>
                              <td width="13%">MONTO</td>
                              <td width="16%">DETALLE DE DEUDAS </td>
                              <td width="11%">EJECUTIVO</td>
                            </tr>
			<%
			if existeinp = "si" then
			cliente = 7
			%>
                            <tr>
                              <td height="20">I.N.P.</td>
                              <td><acronym title="MODULO DE GESTI&Oacute;N PARA EL CLIENTE I.N.P."><a href="javascript:ventanaIngresoG('detalle_gestiones_terreno.asp?rut=<%=rut_deudor%>&cliente=<%=cliente%>')">MODULO DE GESTION DE TERRENO</a></acronym></td>
							  <td></td>
                              <td></td>
                              <td></td>
                              <td></td>
		  ...
		  monto=0
			do until rsDEU.eof%>
                            <tr>
                              ...
                              <td><acronym title="MODULO DE GESTI&Oacute;N PARA EL CLIENTE <%=rsDEU("DESC_CLI")%>"><a href="javascript:ventanaIngresoG('detalle_gestiones_terreno.asp?rut=<%=rut_deudor%>&cliente=<%=rsDEU("COD_CLI")%>')">MODULO DE GESTION DE TERRENO</a></acronym></td>
