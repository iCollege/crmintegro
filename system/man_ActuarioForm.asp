...
<%
    ...
    AbrirSCG()
	recordset_Actuario Conn, srsRegistro, IntId
...
<HTML>
<HEAD><TITLE>Mantenedor de Actuarios</TITLE>
...
<FORM NAME="mantenedorForm"  action="man_ActuarioAction.asp" method="POST" onmouseover="highlightButton('start')" onmouseout="highlightButton('')">
...
<table width="100%" border="0" cellpadding=2 cellspacing=0>
    <tr>
     <td  width="26%" align=center>
		...
		If strFormMode = "Nuevo" Then
        	'general_MostrarCampo "IDACTUARIO", False, Null, Null, srsRegistro

        Else
            'Response.Write srsRegistro("IDACTUARIO")
            Response.Write "<INPUT TYPE=HIDDEN NAME=IDACTUARIO VALUE=""" & srsRegistro("IDACTUARIO") & """>"
 ...
 <table width="100%" border="0" CLASS="tabla1">
    	<tr BGCOLOR="#FFFFFF">
    		<td class="hdr_i"><img src='../images/cuadrado_t1.gif' align='absmiddle'>&nbspINGRESO ACTUARIOS</Font></td>
     </tr>
</Table>
...
<table width="100%" border="0" CLASS="tabla1">
 	<tr BGCOLOR="#FFFFFF">
		<td class="hdr_i">Nombre Actuario</Font></td>
		<td class="td_t"><% general_MostrarCampo "NOMACTUARIO", False, Null, Null,srsRegistro %></td>
	</TR>
	<tr BGCOLOR="#FFFFFF">
		<td class="hdr_i">Codigo</Font></td>
		<td class="td_t"><% general_MostrarCampo "COD_INTERNO", False, Null, Null,srsRegistro %></td>
	</TR>
	<tr BGCOLOR="#FFFFFF">
...
<table width="100%" border="0">
     <TR>
	  <td align=center  width="25%">
	   ...
	   <input type="BUTTON" value="Terminar" name="terminar" onClick="Terminar('man_Actuario.asp');return false;"></TD>
	  </TD>
    </TR>
    <%If sintNuevo = 1 Then %>
    <TR>
...
function Refrescar(strTipo){
	...
	mantenedorForm.action='man_ActuarioForm.asp?strTipoPropiedad=' + strTipo;
	if (mantenedorForm.strFormMode.value == 'Nuevo') {
		location.href="man_ActuarioForm.asp?sintNuevo=1&strTipoPropiedad=" + strTipo;
		}
	else {
