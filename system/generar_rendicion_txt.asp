...
<title>ATO</title>
				...
				Do While not rsCaja.Eof
					...
					If Not rsDetCaja.eof Then
						...
						Do While not rsDetCaja.Eof
							...
							''strLinea=strLinea & strDetFolio&strDetTipoDoc&strDetMontoPagado&strDetFechaPago&strDetNroCheque&strDetBanco&strDetPlaza&strDetTipoPago&strCRP&strCajero&strLote&strSecuencia&strCanalPago&strTipoCliente&"<BR>"

							strSql = "INSERT INTO RENDICION_TXT (RUT,CUENTA,NRODOC,MONTO,FECHA_PAGO,CODCLIENTE, TIPOOP, TIPO)"
							strSql = strSql & " VALUES('" & strRut & "','" & strCuenta & "','" & strDetFolio & "','" & strDetMontoPagado & "','" & rsCaja("FECHA_PAGO") & "','" & intCliente & "','" & rsCaja("TIPOP") & "','I')"
				...
				Do While not rsCaja.Eof
					...
					If Not rsDetCaja.eof Then
						...
						Do While not rsDetCaja.Eof
							...
							strSql = "INSERT INTO RENDICION_TXT (RUT,CUENTA,NRODOC,MONTO,FECHA_PAGO,CODCLIENTE, TIPOOP, TIPO)"
							strSql = strSql & " VALUES('" & strRut & "','" & strCuenta & "','" & strDetFolio & "','" & strDetMontoPagado & "','" & rsCaja("FECHA_PAGO") & "','" & intCliente & "','" & rsCaja("TIPOP") & "','D')"
		...
		Response.write strCabecera & "<BR>" & strLinea
