					  ...
					  <table width="100%" height="420" border="0">
						  <tr><td height="379" valign="top" background="../images/fondo_coventa.jpg"><p><img src="../lib/TIT_PANEL_DE_CONTROL.gif" width="740" height="22"></p>
						    ...
						    <table width="100%" border="0">
                              <tr>
                                <td width="25%" height="21" bgcolor="#<%=session("COLTABBG")%>"><span class="Estilo30"> MODULOS </span></td>
                                <td width="25%">&nbsp;</td>
                                <td width="25%">&nbsp;</td>
                              </tr>
                              <tr>
                                <td bgcolor="#FF9900"><a href="scg_cheq.asp">1.1.- CARGA CHEQUES</a> </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
                              <tr>
                                <td class="Estilo30" bgcolor="#FF9900"><a href="javascript:ventanaInformes('scg_cobr.asp')">1.2.- MODULO COBRADORES</a> </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
                              <tr>
...
window.open(URL,"INFORMACION","width=850, height=350, scrollbars=yes, menubar=no, location=no, resizable=yes")
}
