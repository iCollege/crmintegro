...
<%
	...
	If trim(strQS) <> "" Then
		...
		'Response.write "<br>cliente=" & Trim(Replace(VstrQS(1),"cliente=",""))
		'Response.write "<br>usuario=" & Trim(Replace(VstrQS(2),"usuario=",""))
		'Response.write "<br>telefono=" & Trim(Replace(VstrQS(2),"telefono=",""))
		'Response.write "<br>campana=" & Trim(Replace(VstrQS(3),"campana=",""))


		session("ses_codcli") = Trim(Replace(VstrQS(1),"cliente=",""))
		rut = Trim(Replace(VstrQS(0),"rut=",""))
		intCodCliente = session("ses_codcli")
		session("session_telefono_discador")=Trim(Replace(VstrQS(2),"telefono=",""))
		...
		strSql="SELECT ID_USUARIO FROM USUARIO WHERE AGENTE_CALL IN ("
		strSql=strSql & " SELECT AGENTE FROM TBD_CAMPANA_DISCADOR"
		strSql=strSql & " WHERE RUT = '" & trim(rut) & "' AND AGENTE IS NOT NULL)"
												...
												<TR bgcolor="#eae7e7">
													...
													<table border=0 width="100%">
														<TR>
															...
															<td align="CENTER"><b>M O D A L I D A D&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;D I S C A D O R (<%=session("session_telefono_discador")%>)</b><td>
														</TR>
													</table>
													</TD>
												</TR>
