...
<%
	...
	strSql=""
	strSql="SELECT TASA_MAX_CONV, DESCRIPCION, TIPO_INTERES, INTERES_MORA FROM CLIENTE WHERE CODCLIENTE ='" & intCliente & "'"
	...
	if not rsTasa.eof then
		...
		intTasaMaxMora = ValNulo( rsTasa("INTERES_MORA"),"N")
	Else
		intTasaMax = 1
		intTasaMaxMora = 0
		strDescripcion = ""
		...
		<TR>
 		...
 		<TR>
			<TD>
				...
				intTasaMensual = intTasaMaxMora/100
