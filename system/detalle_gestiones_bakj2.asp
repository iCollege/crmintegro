...
<%
	...
	if rut="" then
		...
		if not rut="" then
			...
			strSql= strSql & " VALUES ('"	&rut&"','"&cliente&"','1','"&correlativo&"','"&categoria&"','"&subcategoria&"','"&gestion&"',getdate(),'"& Mid(time,1,8) &"',"& session("session_idusuario") & "," & fechacompromiso & ",'" & comprobante & "'," & fechacancelo & ",'" & UCASE(observaciones) & "','" & Trim(correlativo2) &"','"& telges & "','" & dirges & "'," & retiro & "," & reagen & ",'" & TX_HORAAGEND & "'," & intIdCampana & ",'ABIERTO')"
