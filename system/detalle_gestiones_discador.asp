...
<%
	...
	if rut="" then
		...
		telges=session("session_telefono_discador")
		...
		if not rut="" then
			...
			If (Trim(categoria) = "2" and Trim(subcategoria) = "1" and Trim(gestion) = "1") Then
				strEstado = "10"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "1"  and Trim(gestion) = "2") Then
				strEstado = "10"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "1") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "2") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "3") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "4") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "5") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "6") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "7") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "8") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "2"  and Trim(gestion) = "9") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "3"  and Trim(gestion) = "1") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "3"  and Trim(gestion) = "3") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "4"  and Trim(gestion) = "1") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "4"  and Trim(gestion) = "2") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "4"  and Trim(gestion) = "3") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "4"  and Trim(gestion) = "4") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "5"  and Trim(gestion) = "1") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "5"  and Trim(gestion) = "2") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "5"  and Trim(gestion) = "3") Then
				strEstado = "10"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "5"  and Trim(gestion) = "4") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "1") Then
				strEstado = "10"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "2") Then
				strEstado = "10"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "3") Then
				strEstado = "10"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "4") Then
				strEstado = "10"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "6"  and Trim(gestion) = "5") Then
				strEstado = "10"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "7"  and Trim(gestion) = "1") Then
				strEstado = "20"
			ElseIf (Trim(categoria) = "2" and Trim(subcategoria) = "7"  and Trim(gestion) = "2") Then
				strEstado = "20"
			End If


			If Trim(reagen) <> "NULL" Then
				strSql = "UPDATE TBD_CAMPANA_DISCADOR SET AGENDA = " & reagen
				strSql = strSql & " WHERE RUT = '" & rut & "' AND COD_CLIENTE = '" & cliente & "'"
				'Response.write "strSql=" & strSql
				Conn.execute(strSql)
			End If

			If strEstado <> "" Then
				strSql = "UPDATE TBD_CAMPANA_DISCADOR SET ESTADO = " & strEstado & ", AGENTE = " &  session("session_idusuario")
				strSql = strSql & " WHERE RUT = '" & rut & "' AND COD_CLIENTE = '" & cliente & "'"
				'Response.write "strSql=" & strSql
				Conn.execute(strSql)
			End If
			...
			Response.End
			If session("strDiscador")="S" Then
				Response.Redirect "principal.asp?rut=" & rut
			Else
				Response.Redirect "mod_discador.asp?rut=" & rut
			End If
  ...
  <tr>
	...
	<table width="100%" border="0" bordercolor="#FFFFFF">
      ...
      <tr class="Estilo8">
        <td><%=rut_deudor%></td>
        <td><%=nombre_deudor%></td>
        <td><a href="mas_telefonos.asp?rut=<%=rut_deudor%>"> <acronym title="INGRESAR UN NUEVO TEL&Eacute;FONO">&nbsp;Ver Teléfonos&nbsp</acronym></a></td>
      </tr>
    </table>
	<table width="100%" border="0" bordercolor="#FFFFFF">
      <tr bordercolor="#999999" bgcolor="#<%=session("COLTABBG")%>" class="Estilo13">
      ...
      <tr class="Estilo8">
        ...
        <td><%if not telefono_deudor="" then%>
            <%=session("session_telefono_discador")%>
            <%end if%></td>
    ...
    <%
	    ...
	    <%
	          AbrirSCG()
			  	strSql="SELECT * FROM GESTIONES_TIPO_CATEGORIA WHERE CODCATEGORIA = 2"
...
function nueva(){
	...
	if((datos.cmbcat.value=='0')||(datos.cmbsubcat.value=='0')){
		...
		validar_fonos()
		datos.action='detalle_gestiones_discador.asp';
		datos.submit();
	}
}
