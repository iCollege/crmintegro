	...
	ssql=ssql + "order by id_gestion desc"
     ...
     <table width="100%" border="0" bordercolor="#FFFFFF">
        <tr bordercolor="#FFFFFF" bgcolor="#<%=session("COLTABBG")%>" class="Estilo13">
		  ...
		  <td class="Estilo4"><font color="yellow">ACCIONES</font></td>
		  <td class="Estilo4"><font color="yellow">ACCIONES</font></td>
          </tr>
		<%do until rsDET.eof
        ...
        <tr bordercolor="#FFFFFF" class="Estilo8">
		  ...
		  <td class="Estilo4"><a href="ver_detalles.asp?gestion=<%=rsDET("id_gestion")%>"><img src="search.png" border="0" alt='' /></a>
		  	&nbsp;&nbsp;
		  <%
		  If session("session_idusuario") = "503" or session("session_idusuario") = "307" Then
		  %>
		  <a href="eliminar.asp?gestion=<%=rsDET("id_gestion")%>"><img src="delete-button.png" border="0" alt='' /></a></td>
		  <%
		  End IF
		  %>	
