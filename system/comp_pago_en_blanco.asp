	...
	<tr>
		<TD VALIGN = "TOP">
			...
			<TABLE VALIGN = "TOP" width="400" border="1" bordercolor = "#000000" cellSpacing=0 cellPadding=1>
				...
				<tr>
					<td HEIGHT="100" VALIGN = "TOP"><span class="Estilo370" width="125">&nbsp;&nbsp;Comprobante válido por el pago por reparación de daño de vehículo patente <INPUT TYPE="text" NAME="" style="WIDTH:60px;HEIGHT=18px;BORDER-WIDTH:0"> según Nro. Siniestro <INPUT TYPE="text" NAME="" style="WIDTH:90px;HEIGHT=18px;BORDER-WIDTH:0"></td>
				</tr>
			</table>
