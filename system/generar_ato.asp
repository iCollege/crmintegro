					...
					If Not rsDetCaja.eof Then
						...
						Do While not rsDetCaja.Eof
							...
							If not RsCuota.eof then
								...
								If Trim(strTipoDocumento)="BOL1" Then strTipoDocumento="39"
							...
							strCuenta="000000000000"&strNroCuenta
							strCuenta=Right(strCuenta,12)
							...
							strLinea=strLinea & strDetFolio&strDetTipoDoc&strDetMontoPagado&strDetFechaPago&strDetNroCheque&strDetBanco&strDetPlaza&strDetTipoPago&strCRP&strCajero&strLote&strSecuencia&strCanalPago&strTipoCliente&strCuenta&"<BR>"
