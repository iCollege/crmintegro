...
<table width="680" height="420" border="0">
  ...
  <tr>
       <td height="20"><img src="../lib/12.gif" width="740" height="22"></td>
  </tr>
  <tr>
    ...
    abrirscg()
	ssql=""
	ssql="SELECT NRODOC,VALORCUOTA,SALDO,GASTOSCOBRANZAS,NSERVICIO,CODCOBRADOR,INTERESES,NROCUOTA,FECHAVENC,CODREMESA,FECHAEMISION FROM CUOTA WHERE RUTDEUDOR='"&rut&"' AND CODCLIENTE='"&cliente&"'"
	...
	<table width="100%" border="0" bordercolor="#FFFFFF">
        <tr bordercolor="#999999" bgcolor="#<%=session("COLTABBG")%>" class="Estilo13">
          ...
          <td width="15%">N&ordm; DE SERVICIO </td>
        ...
        <tr bordercolor="#999999" >
          ...
          <td><div align="right"><%=rsDET("NSERVICIO")%></div></td>
