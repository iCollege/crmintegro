...
<%
    ...
    AbrirSCG()
	recordset_Abogado Conn, srsRegistro, IntId
...
<HTML>
<HEAD><TITLE>Mantenedor de Abogados</TITLE>
...
<FORM NAME="mantenedorForm"  action="man_AbogadoAction.asp" method="POST" onmouseover="highlightButton('start')" onmouseout="highlightButton('')">
...
<table width="100%" border="0" cellpadding=2 cellspacing=0>
    <tr>
     <td  width="26%" align=center>
		...
		If strFormMode = "Nuevo" Then
        	'general_MostrarCampo "IDABOGADO", False, Null, Null, srsRegistro

        Else
            'Response.Write srsRegistro("IDABOGADO")
            Response.Write "<INPUT TYPE=HIDDEN NAME=IDABOGADO VALUE=""" & srsRegistro("IDABOGADO") & """>"
 ...
 <table width="100%" border="0" CLASS="tabla1">
    	<tr BGCOLOR="#FFFFFF">
    		<td class="hdr_i"><img src='../images/cuadrado_t1.gif' align='absmiddle'>&nbspINGRESO ABOGADOS</Font></td>
     </tr>
</Table>
...
<table width="100%" border="0" CLASS="tabla1">
 	<tr BGCOLOR="#FFFFFF">
		<td class="hdr_i">Nombre Abogado</Font></td>
		<td class="td_t"><% general_MostrarCampo "NOMABOGADO", False, Null, Null,srsRegistro %></td>
	</TR>
	<tr BGCOLOR="#FFFFFF">
...
<table width="100%" border="0">
     <TR>
	  <td align=center  width="25%">
	   ...
	   <input type="BUTTON" value="Terminar" name="terminar" onClick="Terminar('man_Abogado.asp');return false;"></TD>
	  </TD>
    </TR>
    <%If sintNuevo = 1 Then %>
    <TR>
...
function Refrescar(strTipo){
	...
	mantenedorForm.action='man_AbogadoForm.asp?strTipoPropiedad=' + strTipo;
	if (mantenedorForm.strFormMode.value == 'Nuevo') {
		location.href="man_AbogadoForm.asp?sintNuevo=1&strTipoPropiedad=" + strTipo;
		}
	else {
