...
-->
		...
		strSql = "SELECT RUTDEUDOR, COD_CLIENTE "
		strSql = strSql & " FROM REPACTACION_ENC WHERE ID_CONVENIO = " & intNroConvenio
		...
		If Not rsCaja.eof Then
			...
			strSql = "SELECT COUNT(*) as CANTC FROM REPACTACION_DET WHERE CUOTA <> 0 AND ID_CONVENIO = " & intNroConvenio
...
<table width="720" border="1" bordercolor = "#000000" cellSpacing=0 cellPadding=1>
	...
	strSql="SELECT CUOTA, FECHA_PAGO, TOTAL_CUOTA FROM REPACTACION_DET WHERE CUOTA <> 0 AND ID_CONVENIO = " & intNroConvenio & " AND CUOTA = " & intNroCuota
	...
	<tr height="285">
		<td valign="TOP">
			...
			<tr>
				<td><img src="reintegra.jpg" width="77" height="25"></td>
				<td><span class="Estilo370"><B>Cuponera de Repactación</B></td>
				<!--td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td-->
				<td>copia Empresa</td>
			</tr>
			</table>
			...
			<tr>
				<td width="260" colspan=2><span class="Estilo370"><b>Nro. Repactacion</b></td>
				<td width="100">&nbsp;</td>
			</tr>
			<tr>
		...
		<td valign="TOP">
			<table width="360" border="0" height="60">
				<tr>
					<td><img src="reintegra.jpg" width="77" height="25"></td>
					<td><span class="Estilo370"><B>Cuponera de Repactacion</B></td>
					<td>copia cliente</td>
				</tr>
				</table>
				<table width="360" border="0">
