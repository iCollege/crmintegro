...
If strArchivo <> "" Then
	...
	strSql = strSql & " TELEFONO_COMERCIAL varchar(15) NULL, TELEFONO_CELULAR varchar(15) NULL, COD_AREA_TA1 int NULL, TELEFONO_ADIC1 varchar(15) NULL,"
	strSql = strSql & " COD_AREA_TA2 int NULL, TELEFONO_ADIC2 varchar(15) NULL, EMAIL varchar(100) NULL, EMAIL_ADIC1 varchar(100) NULL )"
	...
	strSql = "SELECT ISNULL(COUNT(*),0) AS CANTIDAD FROM TMP_CARGA_UBICABILIDAD WHERE LEN(TELEFONO_PARTICULAR) > 10 OR LEN(TELEFONO_COMERCIAL) > 10 OR LEN(TELEFONO_CELULAR) > 10 OR LEN(TELEFONO_ADIC1) > 10 OR LEN(TELEFONO_ADIC2) > 10"
	...
	strSql = "exec proc_IngresaDirecciones '" & strAsignacion & "','" & Request("CB_CLIENTE") & "'"
	Conn.Execute strSql,64

	strSql = "exec proc_IngresaFonos_cel '" & strAsignacion & "','" & Request("CB_CLIENTE") & "'"
	Conn.Execute strSql,64

	strSql = "exec proc_IngresaFonos_tc '" & strAsignacion & "','" & Request("CB_CLIENTE") & "'"
	Conn.Execute strSql,64

	strSql = "exec proc_IngresaFonos_tp '" & strAsignacion & "','" & Request("CB_CLIENTE") & "'"
	Conn.Execute strSql,64

	strSql = "exec proc_IngresaFonos_ta '" & strAsignacion & "','" & Request("CB_CLIENTE") & "'"
	Conn.Execute strSql,64

	strSql = "exec proc_IngresaFonos_ta2 '" & strAsignacion & "','" & Request("CB_CLIENTE") & "'"
	Conn.Execute strSql,64

	strSql = "exec proc_IngresaEmail '" & strAsignacion & "','" & Request("CB_CLIENTE") & "'"
	Conn.Execute strSql,64

	strSql = "exec proc_IngresaEmail_adic '" & strAsignacion & "','" & Request("CB_CLIENTE") & "'"
	Conn.Execute strSql,64
	...
	%>
	<table>
	<tr><td>Direcciones: <%= intDirNueva %>&nbsp;<td>
	<tr><td>Telefonos: <%= intTelNuevo %>&nbsp;<td-->
