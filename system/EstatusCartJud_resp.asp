...
<%
	...
	abrirscg()
		strSql="SELECT IsNull(COUNT(DISTINCT RUTDEUDOR),0) AS CUANTOS, IsNull(SUM(SALDO),0) AS SUMA FROM CUOTA WHERE IDGJUDICIAL IS NOT NULL AND ESTADO_DEUDA = '1' " & strSqlUsuario
		...
		strSql="SELECT IsNull(COUNT(DISTINCT RUTDEUDOR),0) AS CUANTOS, IsNull(SUM(SALDO),0) AS SUMA FROM CUOTA WHERE IDGJUDICIAL IS NOT NULL AND ESTADO_DEUDA = '2'" & strSqlUsuario
		set rsTemp= Conn.execute(strSql)
		If not rsTemp.eof then
		...
		strSql="SELECT IsNull(COUNT(DISTINCT RUTDEUDOR),0) AS CUANTOS, IsNull(SUM(SALDO),0) AS SUMA, IDGJUDICIAL FROM CUOTA WHERE ESTADO_DEUDA = 1 AND IDGJUDICIAL IS NOT NULL " & strSqlUsuario & " GROUP BY IDGJUDICIAL"
			...
			<TR>
				...
				<td>
					<select name="CB_EJECUTIVO">
						...
						if not rsTemp.eof then
							do until rsTemp.eof%>
							<option value="<%=rsTemp("ID_USUARIO")%>"<%if intEjecutivo=rsTemp("ID_USUARIO") then response.Write("Selected") End If%>><%=rsTemp("LOGIN")%></option>
							<%
							rsTemp.movenext
							loop
						end if
...
<tr BGCOLOR="#FFFFFF">
	<td>
		...
		<tr BGCOLOR="#FFFFFF">
		    ...
		    <td bordercolor="#0000FF" align="center"><a href="informe_estatus.asp?intGestion=T&intDePPal=1"><%=FN(intTotalProceso,0)%></a></td>
		    <td bordercolor="#0000FF">&nbsp;</td>
		</tr>
	  </table>
	</td>
    <td>
		...
		<tr BGCOLOR="#FFFFFF">
			<td>&nbsp;</td>
			<td bordercolor="#0000FF" align="center"><a href="informe_estatus.asp?intGestion=12&intEjecutivo=<%=intEjecutivo%>&intDePPal=1"><%=FN(intTotalConPago,0)%></a></td>
			<td>&nbsp;</td>
		</tr>
		</table>
    </td>
    <td>
		...
		<tr BGCOLOR="#FFFFFF">
			<td>&nbsp;</td>
			<td bordercolor="#0000FF" align="center"><a href="informe_estatus.asp?intGestion=13&intEjecutivo=<%=intEjecutivo%>&intDePPal=1"><%=FN(intTotalConAvenimiento,0)%></a></td>
			<td>&nbsp;</td>
		</tr>
		</table>
    </td>
    <td>
		...
		<tr BGCOLOR="#FFFFFF">
			<td>&nbsp;</td>
			<td bordercolor="#0000FF" align="center"><a href="informe_estatus.asp?intGestion=R&intEjecutivo=<%=intEjecutivo%>&intDePPal=1"><%=FN(intTotalRetiro,0)%></a></td>
			<td>&nbsp;</td>
		</tr>
		</table>
    </td>
...
<table width="725" height="175" border="0" align="center">
  <tr height="35">
    ...
    <td width="55" bgcolor="#0000FF" align="center"><span class="Estilo5"><%=intInubicable%></span></td>
    <td width="20" align="center"><span class="Estilo4">&nbsp</span></td>
  ...
  <tr height="35">
      ...
      <a href="informe_estatus.asp?intGestion=3&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Inubicab.</a></span>
      </span></td>
      <td align="center"><span class="Estilo4">&nbsp</span></td>
      <td align="center"><span class="Estilo4">&nbsp</span></td>
      <td align="center"><span class="Estilo4">&nbsp</span></td>
  ...
  <tr height="35">
    <td align="center"><span class="Estilo4">
    <a href="informe_estatus.asp?intGestion=1&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Recien Asignados</a></span>
    </td>
    <td align="center"><span class="Estilo4">&nbsp</span></td>
    <td align="center"><span class="Estilo4">
    	<a href="informe_estatus.asp?intGestion=2&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Verif.de Domicilio</a></span>
    </span></td>
    ...
    <td align="center"><span class="Estilo4">&nbsp</span></td>
    <td align="center"><span class="Estilo4">
    <a href="informe_estatus.asp?intGestion=7&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Busqueda Negativa</a>
    </span></td>
    <td align="center"><span class="Estilo4">&nbsp</span></td>
    <td align="center"><span class="Estilo4">&nbsp</span></td>
    <td align="center"><span class="Estilo4">&nbsp</span></td>
  ...
  <tr height="35">
      ...
      <td align="center"><span class="Estilo4">&nbsp</span></td>
      <td align="center"><span class="Estilo4">
      <a href="informe_estatus.asp?intGestion=4&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Ubicables</a></span>
      </span></td>
      <td align="center"><span class="Estilo4">&nbsp</span></td>
      <td align="center"><span class="Estilo4">
      <a href="informe_estatus.asp?intGestion=5&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Ingres. a Tribunal</a></span>
      </span></td>
      <td align="center"><span class="Estilo4">&nbsp</span></td>
      <td align="center"><span class="Estilo4">
      <a href="informe_estatus.asp?intGestion=6&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Notificacion</a></span>
      </span></td>
      <td align="center"><img src="../images/flecha_azul_abajo.jpg" width="20" height="11"></td>
  ...
  <tr height="35">
      ...
      <td align="center"><span class="Estilo4">&nbsp</span></td>
      <td align="center"><span class="Estilo4">
      <a href="informe_estatus.asp?intGestion=8&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Busqueda Positiva</a>
      </span></td>
      <td align="center"><span class="Estilo4">&nbsp</span></td>
      <td align="center"><span class="Estilo4">
      <a href="informe_estatus.asp?intGestion=9&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Comparendo</a>
      </span></td>
      <td align="center"><span class="Estilo4">&nbsp</span></td>
      <td align="center"><span class="Estilo4">
      <a href="informe_estatus.asp?intGestion=10&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Para Fallo</a>
      </span></td>
      <td align="center"><span class="Estilo4">&nbsp</span></td>
      <td align="center"><span class="Estilo4">
      <a href="informe_estatus.asp?intGestion=11&intEjecutivo=<%=intEjecutivo%>&intDePPal=1">Terminado</a>
      </span></td>
  </tr>
</table>
<p>&nbsp;</p>
...
<tr BGCOLOR="#FFFFFF">
	<td>
		...
		<tr BGCOLOR="#FFFFFF">
			<td bordercolor="#0000FF">&nbsp;</td>
		    <td bordercolor="#0000FF" align="center"><a href="informe_estatus.asp?intGestion=T&intEjecutivo=<%=intEjecutivo%>&intDePPal=1"><%=FN(intTotalMontoProceso/1000000,0)%> mm$</a></td>
		    <td bordercolor="#0000FF">&nbsp;</td>
		</tr>
	  </table>
	</td>
    <td>
		...
		<tr BGCOLOR="#FFFFFF">
			<td>&nbsp;</td>
			<td bordercolor="#0000FF" align="center"><a href="informe_estatus.asp?intGestion=12&intEjecutivo=<%=intEjecutivo%>&intDePPal=1"><%=FN(intMontoTotalConPago/1000000,0)%> mm$</a></td>
			<td>&nbsp;</td>
		</tr>
		</table>
    </td>
    <td>
		...
		<tr BGCOLOR="#FFFFFF">
			<td>&nbsp;</td>
			<td bordercolor="#0000FF" align="center"><a href="informe_estatus.asp?intGestion=13&intEjecutivo=<%=intEjecutivo%>&intDePPal=1"><%=FN(intMontoTotalConAvenimiento/1000000,0)%> mm$</a></td>
			<td>&nbsp;</td>
		</tr>
		</table>
    </td>
    <td>
		...
		<tr BGCOLOR="#FFFFFF">
			<td>&nbsp;</td>
			<td bordercolor="#0000FF" align="center"><a href="informe_estatus.asp?intGestion=R&intEjecutivo=<%=intEjecutivo%>&intDePPal=1"><%=FN(intTotalMontoRetiro/1000000,0)%> mm$</a></td>
			<td>&nbsp;</td>
		</tr>
		</table>
    </td>
